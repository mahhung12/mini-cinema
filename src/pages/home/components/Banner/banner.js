...
import Spider from "../../../../assests/imgs/spider-man.png";

function Banner() {
    return (
        <div className="banner-container">
            <div className="banner-container__animations">
                <img
            ...
            <div className="banner-container__des">
                <div className="rankings">
                    ...
                    <h2>#7 in Movies Today</h2>
                </div>
                <div className="description-movie">
                    In this reboot of the superhero franchise,
                    high school lad Peter Parker learns to wield
                    his newfound powers while facing down
                    arch-villain The Lizard.
                </div>
                <div className="btn-func">
                    <button className="btn-func__play">
                        <svg
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                    ...
                    <button className="btn-func__info">
                        <svg
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
